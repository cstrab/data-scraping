...
class Bot:
    ...
    def __init__(self):
        ...
        # Get bar size
        self.barsize = input("Enter barsize you want to trade in minutes : ")
        mintext = " min"
    ...
    # Pass realtime bar data back to our bot objects
    def on_bar_update(self, reqId, bar, realtime):
        ...
        if (realtime == False):
            ...
            if (minutes_diff > 0 and math.floor(minutes_diff) % self.barsize == 0):
                # Entry - if we have a higher high, a higher lower and we cross 50 SMA Buy
                #1.) SMA
                closes = []
